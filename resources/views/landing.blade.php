...
<div class="about-section">
    ...
    <div class="about-content">
        <section>
            ...
            <p>このサービスは学内のイベントを管理するためのサービスです。イベントを開催、参加することで他コースの学生や先輩、後輩との繋がれる環境を提供します。</p>
        </section>
        <section>
            <h2><i class="fa fa-users" aria-hidden="true"></i>三人寄れば文殊の知恵</h2>
            <p>ことわざにもあるように、1人では難しいことも、みんなでやれば出来ます。一緒に勉強したり、切磋琢磨し技術を磨く"仲間"を見つけましょう。</p>
        </section>
        <section>
        ...
        <section>
            ...
            <p>.Linkerでは自分に合ったイベントをすぐに見つけるための機能があります。イベントやプロフィールに好きなタグを設定することで、自分に合ったイベントを探すことが出来ます。</p>
        </section>
        <section>
            <h2><i class="fa fa-search" aria-hidden="true"></i>空いてる教室を検索</h2>
            <p>授業の時間割や登録されているイベントを考慮し、空いている教室を検索することが出来るため、教室の確保が簡単に！</p>
        </section>
    </div>
</div>
